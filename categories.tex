...
statements, the programmer interacts directly with the system in a sort of
...
variables and hypothesis, and otherwise make progress towards the proof of the
...
The approach taken by systems like Dafny~\cite{leino2010dafny}. The programmer
...
Some systems, such as Dafny, permit annotations that rise nearly to the level of
...
such a restricted system and pushes the ``verify button'', invoking the symbolic
...
verification''---no proof annotations are necessary. Such systems have been used
