...
\texttt{IHre1} in a few goals below, but the relevant terms are stuck under
...
\figurename~\ref{F:r_derive2}. I can use this version to obtain witness for the
existential claim on the left of the goal, and reason with \texttt{IHre1} to
